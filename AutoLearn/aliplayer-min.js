...
! function n(a, s, l) {
    ...
    1: [
        function (e, t, i) {
            ! function () {
                ...
                function l(o, e) {
                    var t;
                    if (e = e || {}, this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = e.touchBoundary || 10, this.layer = o, this.tapDelay = e.tapDelay || 200, this.tapTimeout = e.tapTimeout || 700, !l.notNeeded(o)) {
                        for (var i = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], r = this, n = 0, a = i.length; n < a; n++) r[i[n]] = s(r[i[n]], r);
                        u && (o.addEventListener("mouseover", this.onMouse, !0), o.addEventListener("mousedown", this.onMouse, !0), o.addEventListener("mouseup", this.onMouse, !0)), o.addEventListener("click", this.onClick, !0), o.addEventListener("touchstart", this.onTouchStart, !1), o.addEventListener("touchmove", this.onTouchMove, !1), o.addEventListener("touchend", this.onTouchEnd, !1), o.addEventListener("touchcancel", this.onTouchCancel, !1), Event.prototype.stopImmediatePropagation || (o.removeEventListener = function (e, t, i) {
                ...
                l.prototype.needsClick = function (e) {
                    ...
                    var i, r;
                    document.activeElement && document.activeElement !== e && document.activeElement.blur(), r = t.changedTouches[0], (i = document.createEvent("MouseEvents")).initMouseEvent(this.determineEventType(e), !0, !0, window, 1, r.screenX, r.screenY, r.clientX, r.clientY, !1, !1, !1, !1, 0, null), i.forwardedTouchEvent = !0, e.dispatchEvent(i)
                    ...
                    } else if (this.needsFocus(a)) return 100 < e.timeStamp - i || s && window.top !== window && "input" === r ? this.targetElement = null : (this.focus(a), this.sendClick(a, e), s && "select" === r || (this.targetElement = null, e.preventDefault())), !1;
    ...
    2: [
        function (e, t, i) {
            var r = e("../ui/component"),
                ...
                l = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.className = t.className ? t.className : "prism-auto-stream-selector", this.addClass(this.className)
                    },
                    createEl: function () {
                    ...
                    bindEvent: function () {
                        ...
                        n.on(e, "click", function () {
                            r._player._changeStream && r._switchUrl && r._player._changeStream(r._switchUrl.index, a.get("Quality_Change_Text")), o.css(r.el(), "display", "none")
                        });
    ...
    3: [
        function (e, t, i) {
            var r = e("../ui/component"),
                ...
                p = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.className = t.className ? t.className : "prism-liveshift-progress", this.addClass(this.className), this._liveshiftService = e._liveshiftService
                    },
                    createEl: function () {
                    ...
                    bindEvent: function () {
                        ...
                        u.domain ? -1 < u.domain.indexOf("localhost") && (t = "//" + u.domain + "/build/skins/default/img/dragcursor.png") : t = "de/prismplayer/" + u.h5Version + "/skins/default/img/dragcursor.png", e.src = t, o.on(this.cursorNode, "mousedown", function (e) {
                            i._onMouseDown(e)
                            ...
                            i._onMouseOut(e)
                        }), this.bindTimeupdate = a.bind(this, this._onTimeupdate), this._player.on(d.Player.TimeUpdate, this.bindTimeupdate), c.isLiveShift(this._player._options) && this._player.on(d.Player.Play, function () {
                    ...
                    _onMouseClick: function (e) {
                        ...
                        a && o == n ? t._player.seek(i) : t._player._loadByUrlInner(o, i, !0), t._player.trigger(d.Private.Play_Btn_Hide), t._liveshiftService.seekTime = i, t._player.trigger(d.Private.EndStart, {
                            toTime: i
                    ...
                    _onMouseUp: function (e) {
                        e.preventDefault(), o.off(this.controlNode, "mousemove"), o.off(this.controlNode, "touchmove"), o.off(this._player.tag, "mouseup"), o.off(this._player.tag, "touchend"), o.off(this.controlNode, "mouseup"), o.off(this.controlNode, "touchend");
                        var t = this._liveshiftService.availableLiveShiftTime,
                            i = this.playedNode.offsetWidth / this.el().offsetWidth * t;
                        this._player.seek(i), this._player.trigger(d.Private.Play_Btn_Hide), this._liveshiftService.seekTime = i, this._player.trigger(d.Private.EndStart, {
                            toTime: i
                        })
                    },
                    ...
                    _onTimeupdate: function (e) {
                        this._updateProgressBar(this.playedNode, this._getCurrentTime()), this._updateCursorPosition(this._getCurrentTime()), this._player.trigger(d.Private.UpdateProgressBar, {
    ...
    4: [
        function (e, t, i) {
            var r = e("../ui/component"),
                ...
                o = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.className = t.className ? t.className : "prism-live-time-display", this.addClass(this.className), this._liveshiftService = e._liveshiftService
                    },
                    createEl: function () {
                        var e = r.prototype.createEl.call(this, "div");
        ...
        function (e, t, i) {
            ...
            n.prototype.handle = function (e) {
                if (this._options.autoPlayDelay) {
                    ...
                    t || (t = o.get("AutoPlayDelayDisplayText").replace("$$", this._options.autoPlayDelay)), this._player.trigger("info_show", t), this._player.trigger("h5_loading_hide"), this._player.trigger("play_btn_hide");
                    var i = this;
    ...
    11: [
        function (n, e, t) {
            var i = n("../config"),
                ...
                s = function () {
                    if (void 0 === window[o] || !window[o]) {
                        ...
                        e = e && -1 < e.indexOf("zh") ? "zh-cn" : "en-us", window[o] = e
                    }
                    return window[o]
                }, l = function (e, t) {
                    var i = d(e),
                        r = "",
                        o = c();
                    r = "flash" == e ? "en-us" == o ? n("./flash/en-us") : "zh-cn" == o ? n("./flash/zh-cn") : t[o] : "en-us" == o ? n("./en-us") : "zh-cn" == o ? n("./zh-cn") : t[o], a.set(i, JSON.stringify(r)), u(e, r)
                }, u = function (e, t) {
                    var i = d(e);
                    window[i] = t
                }, c = function () {
            ...
            e.exports.setCurrentLanguage = function (e, t, i) {
                ...
                window[o] = e, l(t, i), e != r && n("../lib/constants").updateByLanguage()
            ...
            unpackPlayReady = function (e) {
                ...
                decode: function (e) {
                    ...
                    var u = new ArrayBuffer(a),
                        c = new Uint8Array(u);
                    for (t = 0; t < s; t += 4) i = d[e.charCodeAt(t)], r = d[e.charCodeAt(t + 1)], o = d[e.charCodeAt(t + 2)], n = d[e.charCodeAt(t + 3)], c[l++] = i << 2 | r >> 4, c[l++] = (15 & r) << 4 | o >> 2, c[l++] = (3 & o) << 6 | 63 & n;
                    return u
                },
                encode: function (e) {
                    var t, i = new Uint8Array(e),
                        r = i.length,
                        o = "";
                    for (t = 0; t < r; t += 3) o += n[i[t] >> 2], o += n[(3 & i[t]) << 4 | i[t + 1] >> 4], o += n[(15 & i[t + 1]) << 2 | i[t + 2] >> 6], o += n[63 & i[t + 2]];
        ...
        function (e, i, t) {
            ...
            i.exports.cache = {}, i.exports.guid = function (e, t) {
                ...
                if (t = t || o.length, e)
                    ...
                    for (n[8] = n[13] = n[18] = n[23] = "-", n[14] = "4", i = 0; i < 36; i++) n[i] || (r = 0 | 16 * Math.random(), n[i] = o[19 == i ? 3 & r | 8 : r]);
                return n.join("")
            }, i.exports.expando = "vdata" + (new Date).getTime(), i.exports.getData = function (e) {
                var t = e[i.exports.expando];
                return t || (t = e[i.exports.expando] = i.exports.guid(), i.exports.cache[t] = {}), i.exports.cache[t]
    ...
    18: [
        function (e, c, t) {
            ...
            c.exports.el = function (e) {
                ...
                var t, i, r, o, n;
                if (t = {}, i = ",autoplay,controls,loop,muted,default,", e && e.attributes && 0 < e.attributes.length)
                    for (var a = (r = e.attributes).length - 1; 0 <= a; a--) o = r[a].name, n = r[a].value, "boolean" != typeof e[o] && -1 === i.indexOf("," + o + ",") || (n = null !== n), t[o] = n;
                return t
                ...
                var i = {}, r = c.exports.findPosition(e),
                    o = e.offsetWidth,
                    n = e.offsetHeight,
                    a = r.top,
                    s = r.left,
                    l = t.pageY,
                    u = t.pageX;
                return t.changedTouches && (u = t.changedTouches[0].pageX, l = t.changedTouches[0].pageY), i.y = Math.max(0, Math.min(1, (a - l + n) / n)), i.x = Math.max(0, Math.min(1, (u - s) / o)), i
    ...
    19: [
        function (e, l, t) {
            ...
            l.exports.on = function (n, e, t) {
                if (n) {
                    ...
                    a.handlers || (a.handlers = {}), a.handlers[e] || (a.handlers[e] = []), t.guid || (t.guid = c.guid()), a.handlers[e].push(t), a.dispatcher || (a.disabled = !1, a.dispatcher = function (e) {
                        if (!a.disabled) {
                            ...
                            if (t)
                                for (var i = t.slice(0), r = 0, o = i.length; r < o && !e.isImmediatePropagationStopped(); r++) i[r].call(n, e)
                        }
                    ...
                    if (r.handlers) {
                        ...
                        if (e) {
                            ...
                            if (n)
                                if (i) {
                                    if (i.guid)
                                        for (var a = 0; a < n.length; a++) n[a].guid === i.guid && n.splice(a--, 1);
                ...
                var i = c.getData(e);
                0 === i.handlers[t].length && (delete i.handlers[t], e.removeEventListener ? e.removeEventListener(t, i.dispatcher, !1) : e.detachEvent && e.detachEvent("on" + t, i.dispatcher)), u.isEmpty(i.handlers) && (delete i.handlers, delete i.dispatcher, delete i.disabled), u.isEmpty(i) && c.removeData(e)
                ...
                if (!e || !e.isPropagationStopped) {
                    ...
                    if (e.target || (e.target = e.srcElement || document), e.relatedTarget = e.fromElement === e.target ? e.toElement : e.fromElement, e.preventDefault = function () {
                        ...
                        var n = document.documentElement,
                            a = document.body;
                        e.pageX = e.clientX + (n && n.scrollLeft || a && a.scrollLeft || 0) - (n && n.clientLeft || a && a.clientLeft || 0), e.pageY = e.clientY + (n && n.scrollTop || a && a.scrollTop || 0) - (n && n.clientTop || a && a.clientTop || 0)
                    }
                ...
                if (e) {
                    ...
                    if ("string" == typeof t) {
                        var o = null;
                        (e.paramData || 0 == e.paramData) && (o = e.paramData, e.paramData = null, e.removeAttribute(o)), t = {
                            type: t,
                            target: e,
                            paramData: o
                        }
                ...
                d = {
                    buildAbsoluteURL: function (e, t, i) {
                        ...
                        if (!o.netLoc && (s.netLoc = n.netLoc, "/" !== o.path[0]))
                            ...
                            } else s.path = n.path, o.params || (s.params = n.params, o.query || (s.query = n.query));
                        return null === s.path && (s.path = i.alwaysNormalize ? d.normalizePath(o.path) : o.path), d.buildURLFromParts(s)
                    },
                    parseURL: function (e) {
                        var t = r.exec(e);
                        return t ? {
        ...
        function (e, t, i) {
            ...
            n.prototype = {
                ...
                avc1toavcoti: function (e) {
                    var t, i = e.split(".");
                    return 2 < i.length ? (t = i.shift() + ".", t += parseInt(i.shift()).toString(16), t += ("000" + parseInt(i.shift()).toString(16)).substr(-4)) : t = e, t
                },
                parseLevelPlaylist: function (e, t, i, r) {
                    ...
                    for (w.lastIndex = 0; null !== (o = w.exec(e));) {
                        ...
                        if (h) {
                            ...
                            if (!isNaN(p.duration)) {
                                var _ = a++;
                                p.type = r, p.start = s, p.levelkey = u, p.sn = _, p.level = i, p.cc = c, p.baseurl = t, p.relurl = (" " + o[3]).slice(1), l.fragments.push(p), s += (d = p).duration, p = new I
                            }
                        } else if (o[4]) {
                        ...
                        } else if (o[5]) p.rawProgramDateTime = (" " + o[5]).slice(1), p.tagList.push(["PROGRAM-DATE-TIME", p.rawProgramDateTime]), void 0 === l.programDateTime && (l.programDateTime = new Date(new Date(Date.parse(o[5])) - 1e3 * s));
                        else {
                            ...
                            switch (o[n]) {
                                ...
                                case "MAP":
                                    var E = new P(y);
                                    p.relurl = E.URI, p.rawByteRange = E.BYTERANGE, p.baseurl = t, p.level = i, p.type = r, p.sn = "initSegment", l.initSegment = p, p = new I;
                                    break;
                                default:
                    ...
                    return (p = d) && !p.relurl && (l.fragments.pop(), s -= p.duration), l.totalduration = s, l.averagetargetduration = s / l.fragments.length, l.endSN = a - 1, l
                },
                load: function (n, a) {
                    var s = this;
                    r.get(n, function (e) {
    ...
    24: [
        function (e, s, t) {
            ...
            s.exports.get = function (e, t, i, r, o) {
                ...
                var l, u, c, d;
                o = o || function () { }, "undefined" == typeof XMLHttpRequest && (window.XMLHttpRequest = function () {
                    try {
                ...
                }), u = new XMLHttpRequest, c = h.parseUrl(t), d = window.location, !(c.protocol + c.host !== d.protocol + d.host) || !window.XDomainRequest || "withCredentials" in u ? (l = "file:" == c.protocol || "file:" == d.protocol, u.onreadystatechange = function () {
        ...
        function (e, a, t) {
            ...
            a.exports.create = Object.create || function (e) {
                ...
                if (a.exports.isArray(e))
                    ...
                    for (var n in e)
                        if (s.call(e, n) && !1 === t.call(i || this, n, e[n])) break; return e
    ...
    27: [
        function (e, t, i) {
            ...
            (n = function () { }).extend = function (e) {
                var t, i;
                for (var r in t = (e = e || {}).init || e.init || this.prototype.init || this.prototype.init || function () { }, (((i = function () {
    ...
    28: [
        function (e, f, t) {
            ...
            f.exports.defaultH5Layout = [{
                ...
                var i = t;
                if (!i && !(i = o.get(n.SelectedStreamLevel))) return o.set(n.SelectedStreamLevel, e[0].definition, 365), 0;
                            ...
                            if ("controlBar" == i.skinLayout[u].name) {
                                ...
                                for (var c = i.skinLayout[u].children.length, d = 0; d < c; d++) {
                                    ...
                                    if ("liveDisplay" == p || "liveIco" == p || "fullScreenButton" == p || "volume" == p || "snapshot" == p || "setting" == p || "subtitle" == p || n && ("progress" == p || "playButton" == p || "timeDisplay" == p)) {
                                        ...
                                        "progress" == p ? h.name = "liveShiftProgress" : "timeDisplay" == p ? h.name = "liveShiftTimeDisplay" : o && "liveDisplay" == p && (h.name = "liveIco"), s.push(h)
                                    }
                                }
                                break
                            } - 1 != l && (i.skinLayout[l].children = s)
                    }
                return (void 0 === e.components || !e.components || _.isArray(e.components) && 0 == e.components.length) && "false" != e.components && (i.components = [g]), i
            }
        }, {
            "../config": 5,
            "../lang/index": 11,
    ...
    31: [
        function (e, C, t) {
            ...
            var r, o, n, a;
            C.exports.IS_MAC_SAFARI = C.exports.IS_MAC && C.exports.IS_SAFARI && !C.exports.IS_CHROME && !C.exports.HAS_FLASH, C.exports.IS_IOS = C.exports.IS_IPHONE || C.exports.IS_IPAD || C.exports.IS_IPOD, C.exports.IOS_VERSION = function () {
                ...
                function (e, t) {
                    var i = this.os = {}, r = this.browser = {}, o = e.match(/Web[kK]it[\/]{0,1}([\d.]+)/),
                    ...
                    i.tablet = !!(s || m || n && !e.match(/Mobile/) || T && e.match(/Tablet/) || x && !e.match(/Phone/) && e.match(/Touch/)), i.phone = !(i.tablet || i.ipod || !(n || u || c || g || y || S && e.match(/Android/) || S && e.match(/CriOS\/([\d.]+)/) || T && e.match(/Mobile/) || x && e.match(/Touch/))), i.pc = !i.tablet && !i.phone, a ? i.name = "macOS" : d ? (i.name = "windows", i.version = function () {
                        var e = navigator.userAgent,
                            t = "";
                        return (-1 < e.indexOf("Windows NT 5.0") || -1 < e.indexOf("Windows 2000")) && (t = "2000"), (-1 < e.indexOf("Windows NT 5.1") || -1 < e.indexOf("Windows XP")) && (t = "XP"), (-1 < e.indexOf("Windows NT 5.2") || -1 < e.indexOf("Windows 2003")) && (t = "2003"), (-1 < e.indexOf("Windows NT 6.0") || -1 < e.indexOf("Windows Vista")) && (t = "Vista"), (-1 < e.indexOf("Windows NT 6.1") || -1 < e.indexOf("Windows 7")) && (t = "7"), (-1 < e.indexOf("Windows NT 6.2") || -1 < e.indexOf("Windows 8")) && (t = "8"), (-1 < e.indexOf("Windows NT 6.3") || -1 < e.indexOf("Windows 8.1")) && (t = "8.1"), (-1 < e.indexOf("Windows NT 10") || -1 < e.indexOf("Windows 10")) && (t = "10"), t
                    }()) : i.name = function () {
                        var e = navigator.userAgent,
                            t = "other",
                            i = C.exports.os;
                        ...
                        return o && (t = "macOS"), "X11" != navigator.platform || r || o || (t = "Unix"), -1 < String(navigator.platform).indexOf("Linux") && (t = "Linux"), r ? "windows" : t
                    }(), r.name = function () {
    ...
    32: [
        function (e, t, i) {
            ...
            t.exports.getAbsoluteURL = function (e) {
                ...
                var t, i, r, o, n;
                o = ["protocol", "hostname", "port", "pathname", "search", "hash", "host"], (r = "" === (i = s.createEl("a", {
                    href: e
                })).host && "file:" !== i.protocol) && ((t = s.createEl("div")).innerHTML = '<a href="' + e + '"></a>', i = t.firstChild, t.setAttribute("style", "display:none; position:absolute;"), document.body.appendChild(t)), n = {};
                for (var a = 0; a < o.length; a++) n[o[a]] = i[o[a]];
                return n.segments = i.pathname.replace(/^\//, "").split("/"), r && document.body.removeChild(t), n
            }
        }, {
            "./dom": 18
        }
    ...
    33: [
        function (e, r, t) {
            ...
            r.exports.formatTime = function (e) {
                ...
                return t = Math.floor(o / 3600), o %= 3600, i = Math.floor(o / 60), r = o % 60, !(t === 1 / 0 || isNaN(t) || i === 1 / 0 || isNaN(i) || r === 1 / 0 || isNaN(r)) && ("00" === (t = 10 <= t ? t : "0" + t) ? "" : t + ":") + (i = 10 <= i ? i : "0" + i) + ":" + (r = 10 <= r ? r : "0" + r)
                ...
                var t = e.split(":"),
                    ...
                    r = 0,
                    o = 0;
                return 3 === t.length ? (i = t[0], r = t[1], o = t[2]) : 2 === t.length ? (r = t[0], o = t[1]) : 1 === t.length && (o = t[0]), 3600 * (i = parseInt(i, 10)) + 60 * (r = parseInt(r, 10)) + (o = Math.ceil(parseFloat(o)))
                ...
                var t, i, r, o, n;
                return 2 !== (i = (e = decodeURIComponent(e)).split("?")).length ? {} : (n = i[1], (t = n.split("&")) ? (r = {}, o = 0, $(t).each(function () {
                    var e;
                ...
                l = function (e) {
                    ...
                    parse: function (e, t, i) {
                        var r, o = e.trim().replace(/\r\n|\n\r|\n|\r/g, "\n").split("\n"),
                            ...
                            a = new s;
                        a.oncue = function (e) {
                            e.id = l(e.startTime) + l(e.endTime) + l(e.text), e.text = decodeURIComponent(escape(e.text)), e.isBig = !1;
    ...
    36: [
        function (e, t, i) {
            ...
            function o() {
                this.window = window, this.state = "INITIAL", this.buffer = "", this.decoder = new r, this.regionList = []
            }
            ...
            function p(t, e, a) {
                ...
                t = t.substr(3), o(), e.endTime = r(), o(),
                    function (e, t) {
                        ...
                        u(e, function (e, t) {
                            switch (e) {
                                ...
                                case "line":
                                    var r = t.split(","),
                                        o = r[0];
                                    n.integer(e, o), n.percent(e, o) && n.set("snapToLines", !1), n.alt(e, o, ["auto"]), 2 === r.length && n.alt("lineAlign", r[1], ["start", d, "end"]);
                                    break;
                                case "position":
                                    r = t.split(","), n.percent(e, r[0]), 2 === r.length && n.alt("positionAlign", r[1], ["start", d, "end", "line-left", "line-right", "auto"]);
                                    break;
                                case "size":
                                    n.percent(e, t);
                                    break;
                        ...
                        "auto" === i && -1 === c.line && (i = -1), t.line = i, t.lineAlign = n.get("lineAlign", "start"), t.snapToLines = n.get("snapToLines", !0), t.size = n.get("size", 100), t.align = n.get("align", d);
                        var r = n.get("position", "auto");
                        "auto" === r && 50 === c.position && (r = "start" === t.align || "left" === t.align ? 0 : "end" === t.align || "right" === t.align ? 100 : 50), t.position = r
                    }(t, e)
            }
            o.prototype = {
                parse: function (e) {
        ...
        function (e, t, i) {
            ...
            function r(e) {
                ...
                window && (window.onbeforeunload = function (e) {
                    if (0 < t._logs.length)
                        if (t._supportLocalStorage) localStorage.setItem("__aliplayer_log_data", JSON.stringify(t._logs));
                        else {
                            t._report();
                            ! function (e) {
        ...
        function (e, t, i) {
            var r = e("../lib/oo"),
                ...
                d = {
                    ...
                    init: function (e, t, i) {
                        void 0 === i && (i = !0), this.trackLog = i, this.player = e, this.requestId = "", this.sessionId = v.guid(), this.playId = 0, this.firstPlay = !0, this.osName = m.os.name, this.osVersion = m.os.version || "", this.exName = m.browser.name, this.exVersion = m.browser.version || "", this._logService = "", t.logBatched && (this._logService = new b(S));
                    ...
                    replay: function () {
                        this.reset(), this.player.trigger(o.Video.LoadStart), this.player.trigger(o.Video.LoadedMetadata), this.player.trigger(o.Video.LoadedData)
                    },
                    bindEvent: function () {
                        var t = this;
                        this.player.on(o.Player.Init, function () {
                        ...
                        }), this.player.on(o.Video.CanPlayThrough, function () { }), this.player.on(o.Video.CanPlay, function () {
                            ...
                            t._waitingDelayLoadingShowHandle && (clearTimeout(t._waitingDelayLoadingShowHandle), t._waitingDelayLoadingShowHandle = null), t._seekEndData && t.seeking && t._onPlayerSeekEnd()
                    ...
                    _onPlayerloadstart: function () {
                        this.loadstartTime = (new Date).getTime(), this.playId = v.guid(), !this.loadstarted && this.player._isPreload() && (this.loadstarted = 1, this._log("STARTPLAY", {
                            vt: (new Date).getTime()
                        }))
                    },
                    ...
                    _onPlayerLoaddata: function () {
                        if (!this._LoadedData && !this.buffer_flag) {
                            var e = 0,
                                t = 0;
                            this.player.tag && (e = this.player.tag.videoWidth, t = this.player.tag.videoHeight), this._log("PREPAREEND", {
                    ...
                    _onPlayerPlay: function () {
                        this.playstartTime = (new Date).getTime(), 0 == this.playId && (this.playId = v.guid()), this.firstPlay || 0 != this.pause_flag || this.seeking || (this.sessionId = v.guid()), this.player._isPreload() || (this._log("STARTPLAY", {
                            vt: (new Date).getTime()
                        }), this.loadstartTime = (new Date).getTime()), this._canPlay && this._reportPlay() || this.buffer_flag && this.pause_flag && (this.pause_flag = 0, this.pauseEndTime = (new Date).getTime(), this._log("RECOVER", {
                            vt: Math.floor(1e3 * this.player.getCurrentTime()),
                    ...
                    _onPlayerSeekStart: function (e) {
                        this.seekStartTime = e.paramData.fromTime, this.seeking = !0, this.startTimePlay = 0, this.seekStartStamp = (new Date).getTime()
                    },
                    ...
                    _log: function (e, t) {
                        if (this.trackLog) {
                            ...
                            var r = S.logReportTo;
                            i.e = d[e] + "", i.ri = this.sessionId, i.t = (new Date).getTime() + "", i.cdn_ip = this._userNetInfo.cdnIp, i.hn = this._userNetInfo.localIp;
                            ...
                            if ("" == (n = n.join("&")) && (n = "0"), i.args = this.encodeURL(n), this._logService) this._logService.add(i);
                                ...
                                u.each(i, function (e, t) {
                                    l.push(e + "=" + t)
                                }), l = l.join("&"), c.jsonp(r + "?" + l, function () { }, function () { })
                            }
    ...
    40: [
        function (e, t, i) {
            ...
            t.exports.create = function (e, t) {
                "function" != typeof t && (t = function () { }), e.readyCallback = t, v.setCurrentLanguage(e.language, "h5", e.languageTexts);
    ...
    41: [
        function (e, t, i) {
            var r = e("../base/player"),
                ...
                l = r.extend({
                    init: function (e, t) {
                        this._isAudio = !0, void 0 === t.skinLayout && (t.skinLayout = s.defaultAudioLayout), r.call(this, e, t)
                    }
                });
            l.prototype.createEl = function () {
                ...
                }), this.setVideoAttrs(), e.parentNode && e.parentNode.insertBefore(t, e), n.insertFirst(e, t), t
            }, t.exports = l
        }, {
            "../../lib/dom": 18,
            "../../lib/object": 26,
    ...
    51: [
        function (e, t, i) {
            ...
            t.exports.handle = function (e) {
                ...
                t._options.autoplay || t._options._autoplay || !t.paused() || (t.trigger(r.Private.H5_Loading_Hide), t.trigger(r.Private.Play_Btn_Show)), t.trigger(r.Player.CanPlay, {
                    loadtime: i
                })
            }
        }, {
    ...
    54: [
        function (e, t, i) {
            ...
            t.exports.handle = function (e) {
                var t = this;
                t.waiting = !1, t._ended = !0, t._monitor && t._monitor._onPlayerInit(), t._options.rePlay ? (t.seek(0), t.tag.play()) : t._options.isLive && t.trigger(r.Private.H5_Loading_Hide), t.trigger(r.Private.Play_Btn_Show), t.trigger(r.Player.Ended)
            }
        }, {
            "../../../../lang/index": 11,
            "../../event/eventtype": 43
            ...
            t.exports.handle = function (e) {
                ...
                if (t.waiting = !1, t._clearTimeout(), t.checkOnline()) {
                    ...
                    if (o.error.code && (i = o.error.code, r = d.VideoErrorCode[o.error.code], n = i + " || " + n), t._options.isLive) t._options.liveRetry > t._liveRetryCount ? t._reloadAndPlayForM3u8() : (t._liveRetryCount = 0, t.trigger(c.Player.LiveStreamStop), t._liveErrorHandle = setTimeout(function () {
                        ...
                        a = a + "\uff0c" + p.get("Error_Retry_Text"), 1 < t._urls.length && t._retrySwitchUrlCount < 3 && -1 == t._options.source.indexOf(".mpd") && (t.switchUrl(), s = !0);
                        var u = {
        ...
        function (e, t, i) {
            var o = e("../../../../lib/event"),
                ...
                r = {
                    ...
                    var e = t.tag;
                    o.on(e, i, function (e) {
                        r.handle.call(t, e, i), i != n.Video.Error && (i == n.Video.ManualEnded && (i = n.Video.Ended), t.trigger(n.Private.LifeCycleChanged, {
                            type: i,
                            data: e
                        }))
                    })
    ...
    57: [
        function (e, t, i) {
            ...
            t.exports.handle = function (e) {
                var t = this;
                t._clearTimeout(), t.trigger(r.Private.AutoStreamHide), t.trigger(r.Player.Pause), t._isManualPause && (t.trigger(r.Private.Play_Btn_Show), t.trigger(r.Private.H5_Loading_Hide)), t.waiting = !1
            }
        }, {
            "../../event/eventtype": 43
        }
    ...
    58: [
        function (e, t, i) {
            ...
            t.exports.handle = function (e) {
                var t = this;
                t.trigger(r.Private.Error_Hide), t.trigger(r.Private.Cover_Hide), t.trigger(r.Private.AutoStreamHide), t.waiting = !1, t.trigger(r.Player.Play)
            }
        }, {
            "../../event/eventtype": 43
        }
    ...
    59: [
        function (e, t, i) {
            ...
            t.exports.handle = function (e) {
                var t = this;
                t.trigger(o.Private.H5_Loading_Hide), t.trigger(o.Private.Cover_Hide), t.trigger(o.Private.Info_Hide), t.waiting = !1, t._ended = !1, t._liveRetryCount = 0, t._vodRetryCount = 0, t._firstDecodeError = !0;
                ...
                t.trigger(o.Private.AutoStreamHide), t.trigger(o.Player.Playing), t.trigger(o.Private.Play_Btn_Hide), t.trigger(o.Private.Error_Hide)
            }
        }, {
            "../../event/eventtype": 43
        }
        ...
        function (e, t, i) {
            ...
            t.exports.handle = function (e) {
                ...
                if (i.waiting && !i._TimeUpdateStamp && (i._TimeUpdateStamp = t), 0 != i.waiting && i._TimeUpdateStamp == t || (i.trigger(n.Private.H5_Loading_Hide), i.trigger(n.Private.AutoStreamHide), i._checkTimeoutHandle && clearTimeout(i._checkTimeoutHandle), i._waitingTimeoutHandle && clearTimeout(i._waitingTimeoutHandle), i._waitingLoadedHandle && clearTimeout(i._waitingLoadedHandle), i.waiting = !1), i._TimeUpdateStamp = t, !i._options.isLive) {
                    var r = i.getDuration(),
                        o = !1;
                    r < t && !i.paused() ? o = !0 : r - t < .2 && 0 <= a.browser.version.indexOf("49.") && !i.paused() ? o = !0 : i.exceedPreviewTime(t) && (o = !0), o && !i._ended && (i.pause(), s.trigger(i.tag, n.Video.ManualEnded))
                }
                i._playingSlientPause && (clearTimeout(i._playingSlientPause), i._playingSlientPause = null), i._playingSlientPause = setTimeout(function () {
            ...
            t.exports.handle = function (e) {
                ...
                if (!i._options.isLive) {
                    var t = this.getCurrentTime(),
                        r = this.getDuration();
                    if (r - t < .5 || r < t) return i.pause(), i._ended = !0, void s.trigger(this.tag, n.Video.ManualEnded)
                }
                i.waiting = !0;
                var o = function () {
                    i._checkTimeoutHandle && (clearTimeout(i._checkTimeoutHandle), i._checkTimeoutHandle = null), i._waitingTimeoutHandle && (clearTimeout(i._waitingTimeoutHandle), i._waitingTimeoutHandle = null), i._waitingLoadedHandle && (clearTimeout(i._waitingLoadedHandle), i._waitingLoadedHandle = null), i._waitingDelayLoadingShowHandle && (clearTimeout(i._waitingDelayLoadingShowHandle), i._waitingDelayLoadingShowHandle = null)
                };
                o(), i._waitingDelayLoadingShowHandle = setTimeout(function () {
                    i.trigger(n.Private.H5_Loading_Show)
                }, 1e3 * i._options.delayLoadingShow), i._TimeUpdateStamp = null, i._checkTimeoutHandle = setTimeout(function () {
                    i.trigger(n.Private.AutoStreamShow)
                }, 1e3 * i._options.loadDataTimeout), i.trigger(n.Player.Waiting), i._waitingTimeoutHandle = setTimeout(function () {
                    if (i.tag && i._options) {
                        i.pause();
                        var e = {
        ...
        function (e, t, i) {
                    ...
                    init: function (e, t) {
                        if (this.tag = e, this.loaded = !1, this.played = !1, this.waiting = !1, this._urls = [], this._currentPlayIndex = 0, this._retrySwitchUrlCount = 0, this._isError = !1, this._isHls = !1, this._liveRetryCount = 0, this._vodRetryCount = 0, this._seeking = !1, this._serverRequestId = 0, this._waitingTimeoutCount = 0, this._waitingReloadTime = 0, this._created = !1, this._firstDecodeError = !0, this._enteredProgressMarker = !1, this._liveShiftSeekStartTime = 0, this._duration = 0, this.__disposed = !1, void 0 === t.skinLayout && (t.skinLayout = p.defaultH5Layout), n.call(this, this, t), this.addClass("prism-player"), t.plugins && a.each(t.plugins, function (e, t) {
                            ...
                            if (this.on(T.Private.ReadyState, function () {
                                ...
                                if (this.trigger(T.Private.PREPARE, "custom"), this._options.autoPlayDelay) {
            ...
            P.prototype.initPlay = function (e) {
                ...
                !1 !== t && 0 !== t.length && (this.options({
                    children: t
                }), n.prototype.initChildren.call(this)), this.UI.cover = v, this.addChild("cover", e), this.UI.playanimation = m, this.addChild("playanimation", e), this.UI.autoStreamSelector = S, this.addChild("autoStreamSelector", e), this.UI.progressMarker = E, this.addChild("progressMarker", e), this.trigger(T.Private.UiH5Ready)
                ...
                }), this.setVideoAttrs(), e || (i.parentNode && i.parentNode.insertBefore(t, i), o.insertFirst(i, t)), t
                ...
                if (this.tag.style.width = this._options.videoWidth || "100%", this.tag.style.height = this._options.videoHeight || "100%", e && this.tag.setAttribute("preload", "preload"), t && !this._isEnabledAILabel() && this.tag.setAttribute("autoplay", "autoplay"), r.IS_IOS && this.tag.setAttribute("poster", "data:image/png;base64,"), this._options.extraInfo)
                    for (var i in this._options.extraInfo) this.tag.setAttribute(i, this._options.extraInfo[i]);
                h.adaptX5Play(this)
                ...
                return e.display_msg = _.get("Error_Offline_Text"), this.trigger(T.Player.Error, e), !1
                ...
                return this.tag && (this.tag.ended || this._ended ? this.replay() : ((this._options.preload || this.loaded) && this.tag.src || this._initLoad(this._options.source), this.trigger(T.Private.Cover_Hide), this.tag.play())), this._isManualPlay = e || !1, this
                ...
                if (p.validateSource(t)) return void 0 === e && (e = !1), this._created || (this._created = !0, this.trigger(T.Private.Created)), this.loaded || this.trigger(T.Player.Init), this._options.autoplay || this._options._autoplay || this._options.preload || e ? (this._options._preload = !0, this._initLoad(t), (this._options.autoplay || this._options._autoplay) && this._startPlay()) : this.trigger(T.Private.Play_Btn_Show), !0;
                var i = {
                    mediaId: this._options.vid ? this._options.vid : "",
                    error_code: c.ErrorCode.InvalidSourceURL,
                    error_msg: "InvalidSourceURL"
                };
                return i.display_msg = _.get("Error_Invalidate_Source"), this.trigger(T.Player.Error, i), !1
                ...
                this.getMetaData(), e && (this._isPreload() && !r.IS_MOBILE ? this.trigger(T.Private.H5_Loading_Show) : (this.trigger(T.Private.H5_Loading_Hide), this.trigger(T.Private.Play_Btn_Show)), this.tag.setAttribute("src", e), this.loaded = !0)
                ...
                var i = 0,
                    r = 0;
                if (this._monitor) return this._options && (i = this._options.vid || "0", r = this._options.from || "0"), this._monitor.updateVideoInfo({
                    video_id: i,
                    album_id: 0,
                    source: this._options.source,
                    from: r
                ...
                this.tag.play = function () {
                    if (console.log("do play"), !o._options.source) {
                        ...
                        return o._options.vid ? e.display_msg = _.get("Error_Vid_Empty_Source") : e.display_msg = _.get("Error_Empty_Source"), void o.trigger(T.Player.Error, e)
                    }
                    o.readyTime = (new Date).getTime();
                    var t = r.apply(o.tag);
                    void 0 !== t && t.then(function () {
                        o.trigger(T.Player.AutoPlay, !0), console.log("do play successfully")
                    })["catch"](function (e) {
                        console.log("do play failed"), !o.tag || !o.tag.paused || o._isError || o._options._autoplay || o._switchedLevel || (o.trigger(T.Private.Play_Btn_Show), o.trigger(T.Private.H5_Loading_Hide), o.trigger(T.Player.AutoPlayPrevented), o.trigger(T.Player.AutoPlay, !1), o._options.cover && o.trigger(T.Private.Cover_Show))
                    });
                ...
                try {
                    this._options.autoplay || this._options.preload || (this.trigger(T.Private.H5_Loading_Hide), this.trigger(T.Private.Play_Btn_Show)), this._options.readyCallback(this)
                } catch (e) {
                    console.log(e)
                }
        ...
        function (e, t, i) {
            var r = e("../../lib/ua"),
                ...
                n = function (e, t) {
                    ...
                    t ? (height = o, width = n) : (height = i.indexOf("%") ? i : i + "px", width = r.indexOf("%") ? r : r + "px"), e.tag.style.width = n, e.tag.style.height = o, e.el().style.height = t ? o : height
                };
                ...
                r.os.android && r.is_X5 && ("h5" == e._options.x5_type && (e.tag.setAttribute("x5-video-player-type", e._options.x5_type), window.onresize = function () {
                    ...
                    ! function (e, t) {
                        if (e.originalLayout) {
                            ...
                            e.el().style.height = i.container.height, e.el().style.width = i.container.width, e.tag.style.width = i.video.width, e.tag.style.height = i.video.height
                        }
                    ...
                    "top" == e._options.x5_video_position && o.removeClass(e.tag, "x5-top-left"), r.os.android && r.is_X5 && e._options.x5LandscapeAsFullScreen && (e.tag.setAttribute("x5-video-orientation", "landscape"), e._x5VideoOrientation = "landscape")
                }), e.on("cancelFullScreen", function () {
                    "top" == e._options.x5_video_position && o.addClass(e.tag, "x5-top-left"), r.os.android && r.is_X5 && e._options.x5LandscapeAsFullScreen && (e.tag.setAttribute("x5-video-orientation", "portrait"), n(e, e._options.x5_fullscreen || "center" == e._options.x5_video_position), e._x5VideoOrientation = "portrait")
                ...
                if (o || function (e, t) {
                    ...
                    t.prototype._checkDrmReady = function () {
                        ...
                        if (h.contentProtocolMixed(s)) {
                            ...
                            return t.display_msg = _.get("Request_Block_Text"), void this.trigger(g.Player.Error, t)
                        }
                        ...
                        function i(i, t) {
                            var r = !i._drm,
                                o = function () {
                                    ...
                                    p.DRMKeySystem[4] && (e.drm.servers[p.DRMKeySystem[5]] = "https://foo.bar/drm/widevine", e.drm.servers[p.DRMKeySystem[4]] = "https://foo.bar/drm/playready"), i._drm.configure(e), a && a(i._drm), r && i._executeReadyCallback(), i._drm.load(i._options.source).then(function () {
                                        i._initPlayBehavior(t), console.log("The video has now been loaded!")
                                    })["catch"](function (e) {
                                        u(i, e)
                                    })
                                }, n = function (e) {
                        ...
                        } (that = this)._isLoadedDrm && "undefined" != typeof shaka ? i(this, e) : (this.trigger(g.Private.H5_Loading_Show), function (e) {
        ...
        function (e, t, i) {
            var o = e("../../ui/component"),
                ...
                m = o.extend({
                        ...
                        if (void 0 === t.skinLayout && (t.skinLayout = p.defaultFlashLayout), o.call(this, this, t), this._id = "prism-player-" + n.guid(), this.tag = e, this._el = this.tag, this._childrenUI = [f], this.initChildren(), this.id = this._id, window[this.id] = this, d.setCurrentLanguage(this._options.language, "flash", this._options.languageTexts), h.openInFile()) {
                            ...
                            if (this._options.vid && this._options.accessKeyId && this._options.securityToken && this._options.accessKeySecret) {
                                ...
                                v.getPlayAuth(this._options, function (e) {
                                    ...
                                    e.sri && (t.sri = e.sri), t.display_msg = e.display_msg, r.trigger(y.Private.Error_Show, t)
                                }, "flash")
                    ...
                    _createPlayer: function () {
                        if (this._options.autoPlayDelay) {
                            var e = new _(this),
                                t = this;
                            e.handle(function () {
                                t._options.autoplay = !0, t._initPlayer(), t._childrenUI = [r, g], t.initChildren()
                            })
                        } else this._initPlayer(), this._childrenUI = [r, g], this.initChildren(); if (!s.HAS_FLASH) {
                    ...
                    onPause: function () {
                        this._status = "pause", this._clearTimeoutHandle(), this.trigger(y.Private.AutoStreamHide), this.trigger("pause")
                    },
                            ...
                            var t = this,
                                i = function () {
                                    t._checkVideoStatusHandler = setTimeout(function () {
                                        ...
                                        "playing" == e.videoStatus && "bufferFull" == e.bufferStatus ? (t._status = "playing", t._clearTimeoutHandle()) : "videoPlayOver" == e.videoStatus && (t._status = "ended", t._clearTimeoutHandle()), i()
                                    }, 500)
                                };
                            i()
                        }
                ...
                if (o || function (e, t) {
                    ...
                    e._Type = t, e._superType = i, e._superPt = i.prototype, e._disposed = !1, t.prototype._checkFlvReady = function () {
                        ...
                        if (c.browser.safari && this.trigger(_.Private.Snapshot_Hide), h.contentProtocolMixed(n)) {
                            ...
                            return t.display_msg = f.get("Request_Block_Text"), void this.trigger(_.Player.Error, t)
                        }
                        ...
                        function i(t, e) {
                            ...
                            t._originalUrl = t._options.source, flvjs.LoggingControl.enableAll = t._options.debug, t._flv = flvjs.createPlayer(n, o), l(t, t._flv), t._flv.on(flvjs.Events.MEDIA_INFO, function (e) {
                                t._metadata = e.metadata
                            }), t._flv.attachMediaElement(t.tag), t._initPlayBehavior(e) && ((t._options.preload || t._options.autoplay) && (t._hasLoaded = !0, t._flv.load()), t._options.autoplay && !t.tag.paused && t._flv.play(), s && s(t._flv), i && t._executeReadyCallback())
                    ...
                    var l = function (u, e) {
                        ...
                        e.on(flvjs.Events.ERROR, function (e, t, i) {
                            ...
                            if (t == flvjs.ErrorDetails.NETWORK_EXCEPTION) {
                                ...
                                !n || 0 != n.toLowerCase().indexOf("http://") && 0 != n.toLowerCase().indexOf("https://") ? (r = p.ErrorCode.InvalidSourceURL, o = f.get("Error_Invalidate_Source_Widthout_Protocal"), c = !0) : o = navigator.onLine ? (r = p.ErrorCode.RequestDataError, f.get("Maybe_Cors_Error")) : (r = p.ErrorCode.NetworkError, f.get("Error_Network_Text"))
                            ...
                            var a = function () {
                                if (setTimeout(function () {
                                    ...
                                    u.logError(e), e.display_msg = o, d.cityBrain && (u.flv = null), u.trigger(_.Player.Error, e)
                                }
                            };
                            if (u._options && u._options.isLive && !c) {
                                ...
                                if (s.liveRetry > u._liveRetryCount) {
                                    ...
                                    u._liveRetryCount++, h.sleep(1e3 * l), u._loadByUrlInner(s.source)
                                } else u._liveErrorHandle && clearTimeout(u._liveErrorHandle), u.trigger(_.Player.LiveStreamStop), u._liveErrorHandle = setTimeout(a, 500)
                            } else {
            ...
            t.exports.inject = function (e, t, i, r, n, o) {
                ...
                if (n || o || function (e, t, i, r) {
                    ...
                    e._Type = t, e._superType = i, e._superPt = i.prototype, e._disposed = !1, t.prototype._checkHlsReady = function () {
                        ...
                        0 == this._liveRetryCount && this.trigger(y.Player.OnM3u8Retry), this._liveRetryCount++
                        ...
                        if (h.contentProtocolMixed(a)) {
                            ...
                            return t.display_msg = g.get("Request_Block_Text"), void this.trigger(y.Player.Error, t)
                        }
                        ...
                        function i(a, e) {
                            ...
                            _.IS_IE11 && n && (i.enableWorker = !1), a._hls = new Hls(i), u(a, a._hls), a._loadSourced = !1, a._hls.attachMedia(a.tag), a._hls.on(Hls.Events.MEDIA_ATTACHED, function () {
                                (a._options.autoplay || a._options.preload || e) && (a._loadSourced = !0, a._hls.loadSource(a._options.source)), a._hls.on(Hls.Events.MANIFEST_PARSED, function () {
                                    ...
                                    a.trigger(y.Player.AudioTrackSwitch, t), setTimeout(function () {
                                        a.trigger(y.Player.AudioTrackSwitched, t)
                                    }, 1e3)
                                }), t && a._executeReadyCallback()
                            })
                        }
                        this._isLoadedHls && "undefined" != typeof Hls ? i(this, e) : (this.trigger(y.Private.H5_Loading_Show), function (e, t, i) {
                            var r = "aliplayer-hls-min.js",
                                o = "https://v4.21tb.com/web-static/alicdn/aliplayer-hls-min.js";
                            ...
                            if (l._options && t.details != Hls.ErrorDetails.FRAG_LOOP_LOADING_ERROR && 1 != l._seeking && (0 != t.fatal || t.type == Hls.ErrorTypes.NETWORK_ERROR)) {
                                ...
                                var n = function () {
                                    if (l.pause(), setTimeout(function () {
                                        ...
                                        l.logError(e), e.display_msg = r, l.trigger(y.Player.Error, e)
                                    }
                                };
                                if (l._options && l._options.isLive) {
                                    ...
                                    if (a.liveRetry > l._liveRetryCount) {
                                        ...
                                        l._liveRetryCount++, h.sleep(1e3 * s), o && l._loadByUrlInner(l._options.source, 0, !0)
                                    } else l._liveErrorHandle && clearTimeout(l._liveErrorHandle), l.trigger(y.Player.LiveStreamStop), l._liveErrorHandle = setTimeout(n, 500)
                                } else {
                    ...
                    function (e, i) {
                        ...
                        if (r) {
                            ...
                            a && a[s], f(o, function (e) {
                                l.__licenseKeys || (l.__licenseKeys = {}), 10 < o.data.length && (l.__licenseKeys[s] = e);
                                var t = u.decode(e);
                                i(t)
                            }, function (e) {
                                var t = {
    ...
    78: [
        function (e, t, i) {
            ...
            n.prototype.loadByMts = function (e) {
                ...
                this.trigger("error_hide"), this._options.source = "", this._isError = !1, this._duration = 0, this._options.cover = "", this._vodRetryCount = 0, this._clearTimeout(), this.reloadNewVideoInfo(e, t, i, r, o, n)
    ...
    79: [
        function (e, t, i) {
            var c = e("../base/player"),
                ...
                v = c.extend({
                    init: function (e, t) {
                        this._authKeyExpiredHandle = new a(this), c.prototype._videoCreateEl || (c.prototype._videoCreateEl = c.prototype.createEl), "mp3" == t.format ? (t.height = "auto", t.mediaType = "audio", c.prototype.createEl = r.prototype.createEl, r.call(this, e, t)) : (c.prototype.createEl = c.prototype._videoCreateEl, t._native = !1, c.call(this, e, t))
                    }
                });
            v.prototype.loadData = function (e, t) {
                ...
                this.trigger(y.Private.H5_Loading_Show), this.service.getDataByAuthInfo(n, this._options.qualitySort, function (e) {
                    if (l.log("COMPLETEFETCHDATA", {
                        ...
                        }), l._urls = e.urls, l._currentPlayIndex = g.findSelectedStreamLevel(l._urls, n.defaultDefinition);
                        ...
                        l._authKeyExpiredHandle.tick(d.AuthKeyRefreshExpired), l.trigger(y.Private.SourceLoaded, t), l.initPlay(a), l.trigger(y.Private.ChangeURL), e.thumbnailUrl && l._thumbnailService.get(e.thumbnailUrl)
                    }
                }, function (e) {
                ...
                t.sri && (l.sri = t.sri), r.logError(l), l.display_msg = (a || _.get("Error_Vod_Fetch_Urls_Text")) + "</br>" + n, r.trigger("error", l), console.log("PrismPlayer Error: " + i + "! error_msg :" + n + ";")
            }, t.exports = v
        }, {
            "../../config": 5,
            "../../lang/index": 11,
    ...
    80: [
        function (e, c, t) {
            ...
            c.exports.randomUUID = function () {
                ...
                if (!e) throw new Error("PrismPlayer Error: vid should not be null!");
                return i || (i = "GET"), o.stringify(r(i + "&" + c.exports.AliyunEncodeURI("/") + "&" + c.exports.AliyunEncodeURI(c.exports.makeUTF8sort(e, "=", "&")), t + "&"))
    ...
    83: [
        function (e, t, i) {
            ...
            t.exports.getDataByAuthInfo = function (e, n, a, s) {
                ...
                e.authInfo && (i.AuthInfo = e.authInfo), e.outputType && (i.OutputType = e.outputType), e.playConfig && (i.PlayConfig = JSON.stringify(e.playConfig)), e.reAuthInfo && (i.ReAuthInfo = JSON.stringify(e.reAuthInfo));
                ...
                l.get(o, function (e) {
                    if (e) {
                        ...
                        var o = function (e, t) {
                            ...
                            var u, c, d = [];
                            return d = 0 < o.length ? o : 0 < r.length ? r : 0 < i.length ? i : n, "asc" == t && d.reverse(), d
        ...
        function (e, t, i) {
            ...
            n.prototype.loadByVod = function (e) {
                var t = "",
                    ...
                    o = "",
                    n = "";
                if (this._options.accessKeyId && this._options.accessKeySecret) t = this._options.accessKeyId, i = this._options.accessKeySecret, r = this._options.securityToken, o = this._options.region, this.log("STARTFETCHDATA", JSON.stringify({
                    it: "sts",
                    pa: {
                        vid: this._options.vid
                    }
                    ...
                    try {
                        ...
                        t = a.AccessKeyId, i = a.AccessKeySecret, r = a.SecurityToken, o = a.Region, n = a.AuthInfo
                    } catch (e) {
                        var s = {
                ...
                if (e == this._options.vid) {
                    ...
                    this.service.loadData(r, this._options.qualitySort, function (e) {
                        o._serverRequestId = e.requestId, 0 != e.urls.length && (o._urls = e.urls), o._authKeyExpiredHandle.tick(l.AuthKeyRefreshExpired)
                    }, function (e) {
                        console.log(e)
                    })
        ...
        function (e, t, i) {
            var o = e("../base/event/eventtype"),
                r = function (i) {
                    ...
                    var r = this;
                    this._isCreated = !1, this._canPlayTriggered = !1, this._defaultTrack = "", i.on(o.Private.ChangeURL, function () {
                        r._isCreated = !1, r._canPlayTriggered = !1, r._defaultTrack = ""
                    }), i.on(o.Player.CanPlay, function () {
                        if (!r._player._drm && !r._canPlayTriggered) {
                            var e = r._getTracks();
                            e && (r._isCreated = !0, i.trigger(o.Player.AudioTrackReady, e), r._notifyDefaultValue(e)), r._canPlayTriggered = !0
                        }
            ...
            r.prototype._notifyDefaultValue = function (e) {
                !this._defaultTrack && 0 < e.length && (this._defaultTrack = e[0]), this._defaultTrack && this._player.trigger(o.Private.SelectorUpdateList, {
                    type: "audio",
    ...
    88: [
        function (e, t, i) {
                    ...
                    if (o.IS_IOS && (e.requestFn = "webkitEnterFullscreen", e.cancelFn = "webkitExitFullscreen", e.fullscreenElement = "webkitFullscreenElement", e.eventName = "webkitfullscreenchange", e.isFullScreen = "webkitDisplayingFullscreen", document[e.requestFn] && (i = !0)), !i) {
                        for (var r = 0; r < 5; r++)
                            if (t[r][1] in document) {
                                e.requestFn = t[r][0], e.cancelFn = t[r][1], e.fullscreenElement = t[r][2], e.eventName = t[r][4], e.isFullScreen = t[r][6];
                                break
                            }
            ...
            c.prototype.requestFullScreen = function () {
                if (!r.isAndroidX5() || !this._player.paused()) {
                    var e = u,
                        t = this._player.el(),
                        i = this;
                    if (o.IS_IOS) return (t = this._player.tag)[e.requestFn](), i._player.trigger(s.Player.RequestFullScreen), this;
                    ...
                    return e && !this._player._options.enableMockFullscreen ? (t[e.requestFn](), this._requestFullScreenTimer = setTimeout(function () {
                        i.isFullScreenChanged || (d.apply(i), i._player.trigger(s.Player.RequestFullScreen)), i._requestFullScreenTimer = null
                    }, 1e3)) : (d.apply(i), this._player.trigger(s.Player.RequestFullScreen)), this._player
                }
                ...
                return e && !this._player._options.enableMockFullscreen ? (document[e.cancelFn](), t._cancelFullScreenTimer = setTimeout(function () {
                    t.isFullScreenChanged || (p.apply(t), t._player.trigger(s.Player.CancelFullScreen)), t._cancelFullScreenTimer = null
                }, 500)) : (p.apply(t), this._player.trigger(s.Player.CancelFullScreen)), this._player.tag.paused || this._player.trigger(s.Player.Play), this._player
            ...
            var d = function () {
                this.isFullWindow = !0, this.docOrigOverflow = document.documentElement.style.overflow, document.documentElement.style.overflow = "hidden", n.addClass(document.getElementsByTagName("body")[0], "prism-full-window")
            }, p = function () {
                this.isFullWindow = !1, document.documentElement.style.overflow = this.docOrigOverflow, n.removeClass(document.getElementsByTagName("body")[0], "prism-full-window")
            };
            t.exports = c
        }, {
            "../../lang/index": 11,
        ...
        function (e, t, i) {
                ...
                p = function (e, t) {
                    ...
                    var r = this,
                        e = function () {
                            ...
                            this._originalPlayUrl = e, this._liveShiftUrl = t._options.liveTimeShiftUrl, this.liveTimeRange = d(t._options.liveStartTime, t._options.liveOverTime), this.availableLiveShiftTime = 0, this.seekTime = -1
                        };
            ...
            r.prototype.validate = function () {
                ...
                if (a.isHls(r)) t = r;
                    ...
                    return this._player._options._autoplay = !0, l.inject(this._player, n, o, this._player._options, "", !0), i
                }
                return t
            }, r.prototype.getTimeline = function (i, r) {
                if (this._player.trigger(c.Private.LiveShiftQueryCompleted), !this._liveShiftUrl) return p(this, (new Date).valueOf() / 1e3), void (i && i());
                var o = this;
                this.queryLiveShift(this._liveShiftUrl, function (e) {
                    ...
                    if (r && e) {
                        var t = {};
                        if (e) {
                            if (-1 < e.indexOf("403 Forbidden")) t.Code = u.ErrorCode.AuthKeyExpired, t.Message = "Query liveshift failed:" + s.get("Error_AuthKey_Text");
                            else {
                                var i;
                                t = e;
                                try {
                ...
                var e = this,
                    t = function () {
                        e._localLiveTimeHandler = setTimeout(function () {
                            e.currentTimestamp++, p(e, e.currentTimestamp), e._player.trigger(c.Private.LiveShiftQueryCompleted), t()
                        }, 1e3)
                    };
                t()
            }, r.prototype.setLiveTimeRange = function (e, t) {
                e || (e = this._player._options.liveStartTime), t || (t = this._player._options.liveOverTime), this.liveTimeRange = d(e, t), p(this, this.currentTimestamp), this._player.trigger(c.Private.LiveShiftQueryCompleted)
            ...
            o.prototype.loadVideoInfo = function (i) {
                ...
                r.jsonp("//tv.taobao.com/player/json/getBaseVideoInfo.do?vid=" + o + "&playerType=3", function (e) {
                    ...
                    _.each(e.data.source, function (e, t) {
                        var i = +e.substring(1);
                        r < i && (r = i)
                    }), t = e.data.source["v" + r], t = _.unescape(t), n._options.source = t, s.inject(n, TaobaoTVPlayer, a.prototype, n._options), n.initPlay(), i && i()
                }, function () {
                ...
                this._monitor && this._monitor.updateVideoInfo({
                    ...
                    t.cover && t._options.autoplay && (Dom.css(t.cover, "display", "none"), delete t.cover), t.tag.play()
                })
            }, t.exports = o
        }, {
            "../../lib/io": 24,
    ...
    94: [
        function (e, t, i) {
            var r = e("../lib/oo"),
                ...
                p = r.extend({
                    init: function (e, t) {
                        ...
                        var r = e.id;
                        "function" == typeof e.id && (r = e.id()), this._id = r + "_component_" + o.guid(), this._children = [], this._childIndex = {}, this._player.on(c.Private.UiH5Ready, function () {
            ...
            p.prototype.renderUI = function () {
                ...
                } else i = e; if (this._children.push(i), "function" == typeof i.id && (this._childIndex[i.id()] = i), "function" == typeof i.el && i.el()) {
                    var r = i.el();
                ...
                if (e = (i = this).options().children)
                    if (a.isArray(e))
                        for (var n = 0; n < e.length; n++) o = "string" == typeof (t = e[n]) ? (r = t, {}) : (r = t.name, t), i.addChild(r, o);
                ...
                if (this.trigger({
                    ...
                    for (var e = this._children.length - 1; 0 <= e; e--) this._children[e].destroy && this._children[e].destroy();
                "function" == typeof this.disposeUI && this.disposeUI(), this.children_ = null, this.childIndex_ = null, this.off(), this._el.parentNode && this._el.id != this._player.id() && this._el.parentNode.removeChild(this._el), o.removeData(this._el), this._el = null
                    ...
                    bindEvent: function () {
                        ...
                        n.on(this.el(), "mouseover", function () {
                            ...
                            if (t._player.paused()) {
                                ...
                                (t._player.getDuration() <= e || t._player._ended || t._player.exceedPreviewTime(e)) && t._player.seek(0), t._player.play(!0)
                ...
                l = r.extend({
                    ...
                    bindEvent: function () {
                        ...
                        this.on("click", function () {
                            ...
                            var e = "on",
                                t = "";
                            i.isOpened ? (i._player._ccService.close(), e = "off") : t = i._player._ccService.open(), i.isOpened = !i.isOpened, i._player.trigger(s.Private.CCStateChanged, {
                                value: e,
                                lang: t
                            }), i.disabledHandler && clearTimeout(i.disabledHandler), i.disabledHandler = setTimeout(function () {
    ...
    97: [
        function (e, t, i) {
            var r = e("../component"),
                ...
                o = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.addClass(t.className || "prism-controlbar"), this.initChildren(), this.onEvent()
                    },
                    createEl: function () {
                        var e = r.prototype.createEl.call(this);
                    ...
                    onEvent: function () {
                        ...
                        if (1 == e.controlBarForOver && (t = "hover"), "hover" == t) {
                            r.hide();
                            var o = function () {
                                r._hideHandler && clearTimeout(r._hideHandler), r._show(), i.fullscreenService.getIsFullScreen() && r._hide()
                            };
                            i.on(n.Private.MouseOver, function () {
                                ...
                                r._hideHandler = setTimeout(function () {
                                    r.hide(), i.trigger(n.Private.HideBar), i.trigger(n.Private.VolumeVisibilityChange, ""), i.trigger(n.Private.SettingListHide)
                                })
                            })
                    ...
                    _show: function () {
                        this.show(), this._player.trigger(n.Private.ShowBar), this.timer && (clearTimeout(this.timer), this.timer = null)
                    },
                    _hide: function () {
                        var e = this,
                            t = this.player().options().showBarTime;
                        this.timer = setTimeout(function () {
                            e.hide(), e._player.trigger(n.Private.HideBar), e._player.trigger(n.Private.VolumeVisibilityChange, ""), e._player.trigger(n.Private.SettingListHide)
                        }, t)
                    },
                    disposeUI: function () {
            ...
            var r = e("../component"),
                ...
                a = r.extend({
                    ...
                    createEl: function () {
                        ...
                        return t ? e.style.backgroundImage = "url(" + t + ")" : o.css(e, "display", "none"), e
                    },
                    _hide: function (e) {
                        var t = document.querySelector("#" + this.id() + " .prism-cover");
                ...
                s = r.extend({
                    ...
                    _show: function (e, t) {
                        ...
                        if (n) {
                            ...
                            document.querySelector("#" + this.id() + " .prism-error-content p").innerHTML = s, document.querySelector("#" + this.id() + " .errorCode .info-content").innerText = i.error_code;
                            ...
                            var p = this;
                            p.playHideHandler && clearTimeout(p.playHideHandler), p.playHideHandler = setTimeout(function () {
                ...
                l = r.extend({
                    ...
                    bindEvent: function () {
                        ...
                        this._player.on(o.Player.RequestFullScreen, function () {
                            ...
                            e._player.fullscreenService.getIsFullScreen() ? e._player.fullscreenService.cancelFullScreen() : e._player.fullscreenService.requestFullScreen(), e._player.trigger(o.Private.MarkerTextHide)
                        })
                    }
                });
            t.exports = l
    ...
    102: [
        function (e, t, i) {
            var r = e("../component"),
                ...
                a = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.className = t.className ? t.className : "prism-info-display", this.addClass(this.className)
                    },
                    createEl: function () {
    ...
    103: [
        function (e, t, i) {
            var r = e("../component"),
                ...
                u = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.className = t.className ? t.className : "prism-live-display", this.addClass(this.className)
                    },
                    createEl: function () {
                        var e = r.prototype.createEl.call(this, "p");
                        return e.innerText = "LIVE", s.isLiveShift(this._player._options) && n.addClass(e, "live-shift-display"), e
                    },
                    bindEvent: function () {
                        var e = document.querySelector("#" + this.id()),
                            t = this;
                ...
                s = r.extend({
                    ...
                    bindEvent: function () {
                        ...
                        this._player.on(o.Player.Play, function () {
                            ...
                            if (t._player.paused()) {
                                var e = t._player.getCurrentTime();
                                (t._player.getDuration() <= e || t._player._ended || t._player.exceedPreviewTime(e)) && t._player.seek(0), t._player.play(!0), t.addClass("playing")
    ...
    106: [
        function (e, t, i) {
            var r = e("../component"),
                ...
                p = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.className = t.className ? t.className : "prism-progress", this.addClass(this.className)
                    },
                    createEl: function () {
                        var e = r.prototype.createEl.call(this);
                    ...
                    bindEvent: function () {
                        var t = this;
                        this.loadedNode = document.querySelector("#" + this.id() + " .prism-progress-loaded"), this.playedNode = document.querySelector("#" + this.id() + " .prism-progress-played"), this.cursorNode = document.querySelector("#" + this.id() + " .prism-progress-cursor"), this.timeNode = document.querySelector("#" + this.id() + " .prism-progress-time"), this.timeNode = document.querySelector("#" + this._player._options.id + " .prism-progress-time");
                        ...
                        u.domain ? -1 < u.domain.indexOf("localhost") && (r = "//" + u.domain + "/build/skins/default/img/dragcursor.png") : r = "de/prismplayer/" + u.h5Version + "/skins/default/img/dragcursor.png", e.src = r, n.on(this.cursorNode, "mousedown", function (e) {
                            t._onMouseDown(e)
                        ...
                        n.on(i, "mousedown", function (e) {
                            ...
                            a.removeClass(i, "prism-progress-hover"), a.removeClass(t.cursorNode, "cursor-hover"), t._progressDown = !1
                        })) : (a.addClass(i, "prism-progress-hover"), a.addClass(t.cursorNode, "cursor-hover")), this.bindTimeupdate = l.bind(this, this._onTimeupdate), this._player.on(d.Player.TimeUpdate, this.bindTimeupdate), s.IS_IPAD ? this.interval = setInterval(function () {
                            t._onProgress()
                        }, 500) : this._player.on(d.Video.Progress, function () {
                            t._onProgress()
                        })
                    ...
                    _getSeconds: function (e) {
                        ...
                        return r < 0 && (r = 0), r > this._player.getDuration() && (r = this._player.getDuration()), r
                    },
                    ...
                    _onMouseClick: function (e) {
                        var t = this,
                            i = t._getSeconds(e);
                        if (t._canSeekable(i)) {
                            t._player.exceedPreviewTime(i) && (i = t._player.getPreviewTime()), t._updateCursorPosition(i);
                            this._mouseClickTimeHandle && clearTimeout(this._mouseClickTimeHandle), this._mouseClickTimeHandle = setTimeout(function () {
                    ...
                    _offMouseUp: function () {
                        n.off(this.controlNode, "mousemove"), n.off(this.controlNode, "touchmove"), n.off(this._player.tag, "mouseup"), n.off(this._player.tag, "touchend"), n.off(this.controlNode, "mouseup"), n.off(this.controlNode, "touchend")
                    },
                    ...
                    _updateCursorPosition: function (e) {
                        ...
                        if (1 != this._player._switchSourcing && t) {
                            var i = 1,
                                ...
                                o = 10 / r,
                                n = e / t - o;
                            0 != r && (i = 1 - o), n = n < 0 ? 0 : n, this.cursorNode && (i < n ? (a.css(this.cursorNode, "right", "0px"), a.css(this.cursorNode, "left", "auto")) : (a.css(this.cursorNode, "right", "auto"), a.css(this.cursorNode, "left", 100 * n + "%")))
                        }
                    },
                    disposeUI: function () {
    ...
    107: [
        function (e, t, i) {
            var r = e("../component"),
                ...
                s = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.className = t.className ? t.className : "prism-marker-text", this.addClass(this.className)
                    },
                    createEl: function () {
                        var e = r.prototype.createEl.call(this, "div");
                            ...
                            if (r._player.trigger(i, e.paramData), t.progressMarker.isCustomized) r._player.trigger(a.Private.LifeCycleChanged, {
                                ...
                                r._thumbnailShowHanlde && (o.css(r.el(), "display", "none"), clearTimeout(r._thumbnailShowHanlde)), r._thumbnailShowHanlde = setTimeout(function () {
                                    if (document.querySelector("#" + r.id() + " p").innerText = t.progressMarker.text || "", t) {
                                        ...
                                        left = e * t.left, width = r.el().offsetWidth, left + width > e ? (o.css(r.el(), "right", "0px"), o.css(r.el(), "left", "auto")) : (left -= width / 2, left = left < 0 ? 0 : left, o.css(r.el(), "right", "auto"), o.css(r.el(), "left", left + "px"))
                                    }
                                }, 30)
                            }
                        }), r._player.on(a.Private.MarkerTextHide, function (e) {
                            r._player.trigger(a.Player.MarkerDotOut), r._player.trigger(a.Private.LifeCycleChanged, {
                                type: a.Player.MarkerDotOut,
                                data: ""
                            }), r._thumbnailShowHanlde && clearTimeout(r._thumbnailShowHanlde), o.css(r.el(), "display", "none")
    ...
    108: [
        function (e, t, i) {
            var r = e("./selector"),
                ...
                o = r.extend({
                    init: function (e, t) {
                        this.Name = d.get("Quality"), this.Type = "quality", this.Tooltip = d.get("Quality_Switch_To"), r.call(this, e, t), this._isMasterLevel = !1
                    },
                        ...
                        this._player.on(p.Private.QualityChange, function (e) {
                            ...
                            if (i.levelSwitch) {
                                ...
                                var o = s._player._currentPlayIndex,
                                    n = t[o - 1].desc,
                                    a = t[o].desc;
                                s.showTip(n + e.paramData + a, 1e3), s._player.trigger(p.Private.SelectorValueChange, t[o].Url)
                            }
                        });
                        ...
                        if (0 < t.length) {
                            ...
                            s.each(t, function (e, t) {
                                if (e.desc) {
                                    ...
                                    t == o && (l.addClass(i, "current"), a._previousSelection = i), r.innerText = e.desc, i.appendChild(r), n.appendChild(i)
                                }
                            })
                        }
                        ...
                        if (this._player._switchSourcing = !0, this._isMasterLevel) {
                            ...
                            for (var i = this._player._urls.length, r = this._player._currentPlayIndex, o = -1, n = 0; n < i; n++)
                                if (this._player._urls[n].Url == e) {
                                    o = this._player._currentPlayIndex = n, u.set(c.SelectedStreamLevel, this._player._urls[n].definition, 365);
                                    break
                                }
                            if (r != o && -1 < o) {
                                var a = this._player.getCurrentTime();
                                this._previousCurrentTime ? "playing" != this._player._status && (a = this._previousCurrentTime) : this._previousCurrentTime = a, this._previousCurrentTime = a;
                                var s = this._player.autoplay || "pause" != this._player._status;
                                this._player.autoplay || 0 != a || (s = !1), this._player._loadByUrlInner(e, a, s)
                            }
                        }
                        var l = this;
                        setTimeout(function () {
    ...
    109: [
        function (e, t, i) {
            var r = e("./selector"),
                ...
                n = r.extend({
                    init: function (e, t) {
                        this.Name = o.get("AudioTrack"), this.Type = "audio", this.Tooltip = o.get("AudioTrack_Switch_To"), r.call(this, e, t)
                    },
                    bindEvent: function () {
                        this.bindCommonEvent();
                        var o = this,
                        ...
                        o._player.on(l.Private.ChangeURL, function () {
                            ...
                            o._hasGeneratedList || (o._clear(), (e = e.paramData) && (a.each(e, function (e, t) {
    ...
    110: [
        function (e, t, i) {
            var r = e("../../component"),
                ...
                l = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.addClass(t.className || "prism-setting-btn"), this._settingList = new n(e, t), e.addChild(this._settingList, t)
                    },
                    createEl: function () {
                        return r.prototype.createEl.call(this, "div")
                    },
                    bindEvent: function () {
                        var e = this;
                        this.on("click", function () {
                            e._settingList.isOpened ? e._player.trigger(o.Private.SettingListHide) : e._player.trigger(o.Private.SettingListShow), e._player.trigger(o.Private.SelectorHide), e._player.trigger(o.Private.MarkerTextHide), e._player.trigger(o.Private.VolumeVisibilityChange, "")
    ...
    111: [
        function (e, t, i) {
            var r = e("./selector"),
                ...
                c = r.extend({
                    init: function (e, t) {
                        this.Name = a.get("Subtitle"), this.Type = "cc", this.Tooltip = a.get("CC_Switch_To"), r.call(this, e, t)
                    },
                    bindEvent: function () {
                        this.bindCommonEvent();
                        var o = this;
                        this._player.on(u.Private.CCStateChanged, function (e) {
                            ...
                            var r = "Off";
                            "on" == t && (r = o._backCCText), o._player.trigger(u.Private.SelectorUpdateList, {
                                type: "cc",
                                text: r
                            })
                        })
                    ...
                    generateList: function (o) {
                        ...
                        s.each(e, function (e, t) {
                            ...
                            e.text == o && (l.addClass(i, "current"), a._previousSelection = i), r.innerText = e.text, i.appendChild(r), n.appendChild(i)
                        })
                    },
                    execute: function (e) {
                        this._backCCText = "", o.set(n.SelectedCC, e, 365), this._player._ccService["switch"](e), this._player.trigger(u.Private.CCChanged, e)
                    }
                });
            t.exports = c
        }, {
    ...
    113: [
        function (e, t, i) {
            var a = e("../../component"),
                ...
                d = a.extend({
                    init: function (e, t) {
                        for (var i in this.isOpened = !1, a.call(this, e, t), this.addClass(t.className || "prism-setting-list"), o) {
                            var r = new o[i](e, t);
                            e.addChild(r, t)
                        }
                    },
    ...
    114: [
        function (e, t, i) {
            var r = e("../../component"),
                ...
                n = r.extend({
                    init: function (e, t) {
                        this._hasGeneratedList = !1, this._previousSelection = null, this._backupSelector = "", r.call(this, e, t), this.className = t.className ? t.className : "prism-" + this.Type + "-selector prism-setting-selector", this.addClass(this.className)
                    },
                    createEl: function () {
                        var e = r.prototype.createEl.call(this, "div");
                    ...
                    bindCommonEvent: function () {
                        ...
                        this._player.on(u.Private.ChangeURL, function () {
                            ...
                            n._player.trigger(u.Private.SelectorHide), n._player.trigger(u.Private.SettingListShow, {
                                type: n.Type,
                            ...
                            var t = e.srcElement ? e.srcElement : e.target,
                                ...
                                r = t.text;
                            if (void 0 !== r) {
                                n._previousSelection && a.removeClass(n._previousSelection, "current"), n._previousSelection = l.findliElementForSelector(t), a.addClass(n._previousSelection, "current"), n.execute && n.execute(i);
                            ...
                            if (t) {
                                ...
                                if (i) {
                                    ...
                                    for (var o = 0; o < r; o++)
                                        if (i[o].text == t.text) {
                                            n._previousSelection && a.removeClass(n._previousSelection, "current"), a.addClass(i[o], "current"), n._previousSelection = i[o];
                                            break
                                        }
                                }
                            }
                            ...
                            if ((e = e.paramData).type == n.Type) {
                                ...
                                n._hasGeneratedList || (n._clear(), n.generateList(n._backupSelector), n._backupSelector = "", n._hasGeneratedList = !0), a.css(t, "display", "block")
                            }
                        });
                        var i = function () {
                            a.css(n.el(), "display", "none"), n._player.trigger(u.Private.UpdateToSettingList, {
                                type: n.Type,
                                text: n._previousSelection ? n._previousSelection.text : ""
                            })
        ...
        function (e, t, i) {
            var r = e("./selector"),
                ...
                o = (e("../../../player/base/event/eventtype"), r.extend({
                    init: function (e, t) {
                        this.Name = u.get("Speed"), this.Type = "speed", this.Tooltip = u.get("Speed_Switch_To"), r.call(this, e, t)
                    },
                    generateList: function () {
                        ...
                        a.each(e, function (e, t) {
                            ...
                            r.innerText = e.text, e.text == u.get("Speed_1X_Text") && (s.addClass(i, "current"), n._previousSelection = i), i.appendChild(r), o.appendChild(i)
                        })
                    },
                    execute: function (e) {
            ...
            var r = e("../component"),
                ...
                s = r.extend({
                    ...
                    bindEvent: function () {
                        ...
                        this._player.on(_.Private.Snapshot_Hide, function () {
                        ...
                        }), a.registerTooltipEvent.call(this, this.el(), n.get("Snapshot")), this.on("click", function () {
                            ...
                            "vertical" == s ? (a.translate(0, e.height), a.scale(1, -1)) : "horizon" == s && (a.translate(e.width, 0), a.scale(-1, 1)), a.drawImage(t, 0, 0, i, r), a.restore(), g(a, h._player.getOptions());
                            var l = "",
                                u = "";
                            try {
                            ...
                            var c = "",
                                d = "",
                                p = "";
                            l && (d = (c = l).substr(c.indexOf(",") + 1), p = f.toBinary(d)), h.trigger(_.Player.Snapshoted, {
                                time: n,
                                base64: c,
                                binary: p,
                                error: u
    ...
    118: [
        function (e, t, i) {
            var r = e("../component"),
                ...
                a = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.className = t.className ? t.className : "prism-thumbnail", this.addClass(this.className)
                    },
                    createEl: function () {
                        var e = r.prototype.createEl.call(this, "div");
                    ...
                    bindEvent: function () {
                        ...
                        o.on(this._el, "mousemove", function (e) {
                            ...
                            if (t && 0 < t.length) {
                                ...
                                if (t[0].isBig) c.css(u.el(), "background", "url(" + i + ")"), c.css(u.el(), "width", t[0].w + "px"), c.css(u.el(), "height", t[0].h + "px"), u._player.log("THUMBNAILCOMPLETE", {
                                    ...
                                    o.onload = function () {
                                        var e = o.width,
                                            t = o.height;
                                        c.css(u.el(), "width", e + "px"), c.css(u.el(), "height", t + "px"), u._player.log("THUMBNAILCOMPLETE", {
                                            ftt: (new Date).getTime() - r
                                        })
                                    }, o.src = i
                                }
                                ...
                                if (e.innerText = t.formatTime, t) {
                                    ...
                                    if (i)
                                        if (i.isBig) {
                                            ...
                                            c.css(u.el(), "background", "url(" + r + ")"), i.w, i.h;
                                            var o = -1 * i.x + "px " + -1 * i.y + "px";
                                            c.css(u.el(), "background-position", o)
                                        } else {
                                            var n = document.querySelector("#" + u.id() + " img");
                                            r = u._player._thumbnailService.makeUrl(i.text), n.src != r && (n.src = r)
                                        } else c.css(u.el(), "border", "none"), c.css(e, "left", "0px");
                                    c.css(u.el(), "display", "block");
                                    var a = 0,
                                        s = i ? u.el().offsetWidth : e.offsetWidth;
                                    a = t.left + s > t.progressWidth ? t.left - s : (a = t.left - s / 2) < 0 ? 0 : a, c.css(u.el(), "left", a + "px")
                                }
                            }, 30)
    ...
    119: [
        function (e, t, i) {
            var r = e("../component"),
                ...
                a = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.className = t.className ? t.className : "prism-time-display", this.addClass(this.className)
                    },
                    createEl: function () {
                        var e = r.prototype.createEl.call(this, "div");
    ...
    120: [
        function (e, t, i) {
            var r = e("../component"),
                ...
                n = r.extend({
                    init: function (e, t) {
                        r.call(this, e, t), this.className = t.className ? t.className : "prism-tooltip", this.addClass(this.className)
                    },
                    createEl: function () {
                        var e = r.prototype.createEl.call(this, "p");
        ...
        function (e, t, i) {
            ...
            t.exports.registerTooltipEvent = function (e, o) {
                ...
                r.on(this.el(), "mouseover", function (e) {
                    a(), n._controlbarTooltipHandler = setTimeout(function () {
                        n._player.trigger(s.Private.TooltipHide)
                    }, 4e3);
                    var t = n.el().offsetLeft,
                        i = n.el().offsetWidth,
                        r = o;
                    "function" == typeof r && (r = o.call(this)), n._player.trigger(s.Private.TooltipShow, {
                        left: t,
                        width: i,
                        text: r
                    })
        ...
        function (e, t, i) {
            var r = e("../component"),
                ...
                c = r.extend({
                    ...
                    bindEvent: function () {
                        var i = this;
                        this.icon = document.querySelector("#" + i.id() + "  .volume-icon"), s.registerTooltipEvent.call(this, this.el(), function () {
                            ...
                            i._player.trigger(a.Private.SettingListHide), i._player.trigger(a.Private.SelectorHide), i._player.trigger(a.Private.VolumeVisibilityChange, t), i._player.trigger(a.Private.MarkerTextHide)
                        });
                        ...
                        n.on(this.el(), "mouseover", function () {
                            o.removeClass(e, "volume-hover-animation"), setTimeout(function () {
                                ...
                                o.removeClass(e, "volume-hover-animation"), o.addClass(t, "volume-hover-animation"), setTimeout(function () {
                                    o.removeClass(t, "volume-hover-animation"), o.addClass(e, "volume-hover-animation")
                                }, 300)
                            }, 300)
                        })
                    }
        ...
        function (e, t, i) {
            var r = e("../component"),
                ...
                s = (e("./util"), e("../../lang/index"), r.extend({
                    ...
                    bindEvent: function () {
                        ...
                        this.icon = document.querySelector("#" + r._player.id() + "  .volume-icon"), this.control = document.querySelector("#" + r.id()), this.volumnValue = document.querySelector("#" + r.id() + "  .volume-value"), this.volumnRange = document.querySelector("#" + r.id() + "  .volume-range"), this.volumnCursor = document.querySelector("#" + r.id() + "  .volume-cursor"), this._player.on(a.Private.VolumeVisibilityChange, function (e) {
                            ...
                            if (!r._shown && t) {
                                ...
                                r._setVolumnUI(i), o.css(r.control, "display", "block"), t && o.css(r.control, "left", t - 5 + "px"), r._shown = !0
                            ...
                            var t = e.paramData; - 1 < t && r._setVolumnUI(t), r._setMuteUI(t)
                    ...
                    _offEvent: function () {
                        n.off(this._player.tag, "mouseup"), n.off(this._player.tag, "touchend"), n.off(this.control, "mousemove"), n.off(this.control, "touchmove"), n.off(this.control, "mouseup"), n.off(this.control, "touchend")
                    },
            ...
            r = this, o = function (e) {
                ...
                i = (t = e).lib.Base, u = t.enc.Utf8, t.algo.HMAC = i.extend({
                    init: function (e, t) {
                        ...
                        for (var o = this._oKey = t.clone(), n = this._iKey = t.clone(), a = o.words, s = n.words, l = 0; l < i; l++) a[l] ^= 1549556828, s[l] ^= 909522486;
    ...
    130: [
        function (e, t, i) {
            ...
            r = this, o = function (e) {
                var t, i, r, o, n, d, a;
                return i = (t = e).lib, r = i.WordArray, o = i.Hasher, n = t.algo, d = [], a = n.SHA1 = o.extend({
                    _doReset: function () {
                    ...
                    _doProcessBlock: function (e, t) {
                        for (var i = this._hash.words, r = i[0], o = i[1], n = i[2], a = i[3], s = i[4], l = 0; l < 80; l++) {
                            ...
                            c += l < 20 ? 1518500249 + (o & n | ~o & a) : l < 40 ? 1859775393 + (o ^ n ^ a) : l < 60 ? (o & n | o & a | n & a) - 1894007588 : (o ^ n ^ a) - 899497514, s = a, a = n, n = o << 30 | o >>> 2, o = r, r = c
                        }
                        i[0] = i[0] + r | 0, i[1] = i[1] + o | 0, i[2] = i[2] + n | 0, i[3] = i[3] + a | 0, i[4] = i[4] + s | 0
                    },
